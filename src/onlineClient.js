...
export async function createRoom({ seed, managers, universe, startingPitchers, bullpenSlots, bullpenMin, temperature, pickTimer, cpu, draftType, nomination, hidePoints, budget, auctionTimer, snakeTimer }) {
