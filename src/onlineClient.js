...
export async function createRoom({ seed, managers, universe, startingPitchers, bullpenSlots, temperature, pickTimer, cpu, draftType, nomination, hidePoints, budget, auctionTimer, snakeTimer }) {
