import { chartSpan } from "../rules/cards.js?v=20260713-x";
import { adventurePool } from "./packs.js?v=20260713-x";
import { npcBudget, trainerById } from "./region.js?v=20260713-x";
