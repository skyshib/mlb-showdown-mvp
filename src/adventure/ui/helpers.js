import { positionsLabel } from "../../rules/cards.js?v=20260714-x";
import { escapeHtml, shortName } from "../../ui/cardFace.js?v=20260714-x";
...
export { cardPanelHtml, escapeHtml, eraYear, rarityTag, shortName, stripCardYear, surname } from "../../ui/cardFace.js?v=20260714-x";
export { describeEvent, halfLabel } from "../../ui/playByPlay.js?v=20260714-x";
