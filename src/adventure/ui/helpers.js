import { positionsLabel } from "../../rules/cards.js?v=20260713-f";
import { escapeHtml, shortName } from "../../ui/cardFace.js?v=20260713-f";
...
export { cardPanelHtml, escapeHtml, eraYear, rarityTag, shortName, stripCardYear } from "../../ui/cardFace.js?v=20260713-f";
export { describeEvent, halfLabel } from "../../ui/playByPlay.js?v=20260713-f";
