import { escapeHtml, menuHtml, clampIndex, cardLine, cardPanelHtml } from "./helpers.js?v=20260713-m";
import { TRAINERS, BADGES, trainerById, isTrainerUnlocked, isTrainerAvailable, rewardCoins, npcBudget, pendingAmbush, ambushSprung, springAmbush, ambushDone } from "../region.js?v=20260713-m";
import { timesBeaten, managerFor, rosterPoints, pointCap, ensureSeasonStats, persistSave } from "../state.js?v=20260713-m";
...
import { dayWhimsy } from "../feats.js?v=20260713-m";
import { validateRoster } from "../../rules/draft.js?v=20260713-m";
import { buildNpcTeam } from "../npcTeams.js?v=20260713-m";
import { startTrainerBattle } from "./battleScreen.js?v=20260713-m";
