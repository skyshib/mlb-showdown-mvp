import { escapeHtml, menuHtml, clampIndex, cardLine, cardPanelHtml } from "./helpers.js?v=20260714-d";
import { TRAINERS, BADGES, trainerById, isTrainerUnlocked, isTrainerAvailable, rewardCoins, npcBudget, pendingAmbush, ambushSprung, springAmbush, ambushDone } from "../region.js?v=20260714-d";
import { timesBeaten, managerFor, rosterPoints, pointCap, ensureSeasonStats, persistSave } from "../state.js?v=20260714-d";
...
import { dayWhimsy } from "../feats.js?v=20260714-d";
import { validateRoster } from "../../rules/draft.js?v=20260714-d";
import { buildNpcTeam } from "../npcTeams.js?v=20260714-d";
import { startTrainerBattle } from "./battleScreen.js?v=20260714-d";
import { playChallenge, playFootfall } from "../../ui/sounds.js?v=20260714-d";
