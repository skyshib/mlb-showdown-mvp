import { escapeHtml, clampIndex } from "./helpers.js?v=20260713-x";
import { sectionedMenu, statLineHtml } from "./statsScreens.js?v=20260713-x";
import { universeConfig } from "../packs.js?v=20260713-x";
import {
  loadHallOfFame,
  hallOfFameByMode,
  MODE_LABELS,
