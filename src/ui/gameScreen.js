...
import { describeEvent, halfLabel } from "./playByPlay.js?v=20260715-c";
import { cardPanelHtml, escapeHtml, shortName, stripCardYear } from "./cardFace.js?v=20260715-c";
import { hydratePhotos } from "./photos.js?v=20260715-c";
