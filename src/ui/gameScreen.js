...
import { describeEvent, halfLabel } from "./playByPlay.js?v=20260714-f";
import { cardPanelHtml, escapeHtml, shortName, stripCardYear } from "./cardFace.js?v=20260714-f";
import { hydratePhotos } from "./photos.js?v=20260714-f";
