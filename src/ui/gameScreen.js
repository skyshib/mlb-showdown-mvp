...
import { describeEvent, halfLabel } from "./playByPlay.js?v=20260713-l";
import { cardPanelHtml, escapeHtml, shortName, stripCardYear } from "./cardFace.js?v=20260713-l";
import { hydratePhotos } from "./photos.js?v=20260713-l";
