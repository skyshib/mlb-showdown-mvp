...
import { describeEvent, halfLabel } from "./playByPlay.js?v=20260714-e";
import { cardPanelHtml, escapeHtml, shortName, stripCardYear } from "./cardFace.js?v=20260714-e";
import { hydratePhotos } from "./photos.js?v=20260714-e";
