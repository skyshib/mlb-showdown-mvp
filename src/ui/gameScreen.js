...
import { describeEvent, halfLabel } from "./playByPlay.js?v=20260713-j";
import { cardPanelHtml, escapeHtml, shortName, stripCardYear } from "./cardFace.js?v=20260713-j";
import { hydratePhotos } from "./photos.js?v=20260713-j";
