...
- The bar that gap must clear **slides with the outs left to get**, from 5.5 control points at the first pitch down to a floor of 1.5. A starter's un-thrown outs are worth something early, when the pen cannot cover the game without them, and nothing by the ninth. A flat bar made every pull a first-inning pull, since the gap itself does not know what inning it is.
